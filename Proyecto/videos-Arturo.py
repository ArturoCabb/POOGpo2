...
class Video():
    ...
    def muestra_datos(self, dato):
        ...
        print("ID del video -> ", dato[0])
        print("Titulo del video -> ", dato[1])
        print("Duración del video -> ", dato[2])
        print("Calificación del video -> ", dato[3])
...
class Peliculas(Video):
    ...
    def pide_datos(self):
        ...
        cadena = self.titulo + "," + self.genero + "," + str(self.duracion) + "," + str(self.calificacion) + "," + self.audencia + "," + "," + "," + ","
        Archivo().buscar(cadena, "P", self.id)

    def muestra_datos(self, dato):
        super().muestra_datos(dato)
        print("Audencia de la Película -> ", dato[4])
        print("Género de la Película -> ", dato[5])
...
class Serie(Peliculas):
    ...
    def pide_datos(self):
        ...
        cadena = self.titulo + "," + self.genero + "," + str(self.duracion) + "," + str(self.calificacion) + "," + self.audencia + "," + str(lf.temporada) + "," + str(self.episodio) + "," + self.tit_episodio + ","
        Archivo().buscar(cadena, "P", self.id)


    def muestra_datos(self, dato):
        super().muestra_datos(dato)
        print("Temporada de la serie -> ", dato[6])
        print("Episodio de la serie -> ", dato[7])
        print("Título del episodio de la serie -> ", dato[8])
...
class Documental(Serie):
    ...
    def pide_datos(self):
        ...
        cadena = self.titulo + "," + self.genero + "," + str(self.duracion) + "," + str(self.calificacion) + "," + self.audencia + "," + str(self.temporada) + "," + str(self.episodio) + "," + self.tit_episodio + "," + self.tema
        Archivo().buscar(cadena, "P", id)


    def muestra_datos(self, dato):
        super().muestra_datos(dato)
        print("Tema del documental -> ", dato[9])
